...
async def get_chatbot_reply_async(
    ...
    # Access the first choice in the list and its 'message' attribute
    first_choice_message = choices[0].message
    # Access the 'content' attribute of the message and strip any leading/trailing whitespace
